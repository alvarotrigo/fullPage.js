...
Personalizaciones de la librería y solicitudes urgentes -a pedido- a un precio razonable. <a href="https://alvarotrigo.com/#contact-page">Consúltame conmigo</a>.
...
## Compatibilidad
fullPage.js es totalmente compatible y funcional con cualquier navegador moderno, tanto como algunos antiguos tales como Internet Explorer 8 y 9 u Opera 12.
Funciona con navegadores que soportan CSS3 tanto como aquellos que no lo soportan, haciéndolo ideal incluso con navegadores antiguos.
...
Esto sería un ejemplo de un enlace precisamente con un enlace de anclaje: https://alvarotrigo.com/fullPage/#secondPage/2 (que es la URL que verás en la URL si accedes a esa sección/diapositiva manualmente).
...
Una vez que adjuntas el archivo correspondiente a la extensión que deseas usar, tendrás que añadirlo antes del archivo de fullPage. Por ejemplo, si deseo usar la extensión `Continuous Horizontal` tendré que añadir el fichero de la extension y después el fichero de fullPage versión extensiones.
...
- `verticalCentered`: (por defecto `true`) centrado vertical de las secciones y diapositivas. Cuando se usa `true`, el contenido de cada sección y diapositiva será empaquetado dentro de un contenedor por la librería. Considera usar delegación en eventos Javascript o usar los eventos dentro del callback `afterRender`.
...
Para relacionar los elementos del menú con las secciones, se requiere del uso del atributo `data-menuanchor` que tendrá que tener el mismo valor que el enlace de anclaje con la sección a la que haga referencia. Por ejemplo:
```html
<ul id="myMenu">
...
- `type`: (parámetro opcional) Si se define como `all` la estructura HTML creada por fullPage.js así como cualquier estilo que haya aplicado serán eliminados. De este modo, se mantendrá el HTMl original, es decir, el usado antes que fullPage.js se iniciase.
...
Será disparado una vez que se cargue la diapositiva de una sección, después que el desplazamiento haya terminado.
...
2. Asegurate que estás usando la última versión de fullPage.js. No se provee soporte a versiones añejas.
...
4. **Se requerirá la reproducción aislada del problema.** Usa [jsfiddle](http://jsfiddle.net/97tbk/418/) o [codepen](https://codepen.io/alvarotrigo/pen/NxyPPp) de ser posible.
...
# Build tasks
¿Deseas crear archivos de distribución de fullpage.js? Dale una mirada a [Build Tasks](https://github.com/alvarotrigo/fullPage.js/wiki/Build-tasks)
...
EL SOFTWARE SE PROPORCIONA "TAL CUAL", SIN GARANTÍA DE NINGÚN TIPO, EXPRESA O IMPLÍCITA, INCLUYENDO PERO NO LIMITADO A GARANTÍAS DE COMERCIALIZACIÓN, IDONEIDAD PARA UN PROPÓSITO PARTICULAR Y NO INFRACCIÓN. EN NINGÚN CASO LOS AUTORES O TITULARES DEL COPYRIGHT SERÁN RESPONSABLES DE NINGUN RECLAMo, DAÑOS U OTRAS RESPONSABILIDADES, YA SEA EN UNA ACCIÓN DE CONTRATO, AGRAVIO O CUALQUIER OTRO MOTIVO, QUE SURJA DE O EN CONEXIÓN CON EL SOFTWARE O EL USO U OTRO TIPO DE ACCIONES EN EL SOFTWARE
