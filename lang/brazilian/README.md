...
- [Extensões fullpage.js](http://alvarotrigo.com/fullPage/extensions/)
...
- [Introdução](https://github.com/alvarotrigo/fullPage.js#introdução)
- [Compatibilidade](https://github.com/alvarotrigo/fullPage.js#compatibilidade)
- [Licença](https://github.com/alvarotrigo/fullPage.js#licença)
- [Uso](https://github.com/alvarotrigo/fullPage.js#uso)
  - [Criando Links para seções ou slides](https://github.com/alvarotrigo/fullPage.js#criando-links-para-secoes-ou-slides)
  - [Criando seções maiores ou menores](https://github.com/alvarotrigo/fullPage.js#criando-secoes-maiores-ou-menores)
  - [Classes de estado adicionadas pelo fullPage.js](https://github.com/alvarotrigo/fullPage.js#classes-de-estado-adicionadas-pelo-fullpagejs)
  - [Lazy loading](https://github.com/alvarotrigo/fullPage.js#lazy-loading)
  - [Reprodução/pausa automática de mídias embutidas](https://github.com/alvarotrigo/fullPage.js#reproducaopausa-automática-de-mídias-embutidas)
  - [Uso de extensões](https://github.com/alvarotrigo/fullPage.js#uso-de-extensões)
- [Opções](https://github.com/alvarotrigo/fullPage.js#opções)
- [Métodos](https://github.com/alvarotrigo/fullPage.js#métodos)
- [Callbacks](https://github.com/alvarotrigo/fullPage.js#callbacks)
- [Reportando falhas](https://github.com/alvarotrigo/fullPage.js#reportando-falhas)
- [Contribuindo para o fullpage.js](https://github.com/alvarotrigo/fullPage.js#contribuindo-para-o-fullpagejs)
- [Changelog](https://github.com/alvarotrigo/fullPage.js#changelog)
- [Tarefas de Build](https://github.com/alvarotrigo/fullPage.js#tarefas-de-build)
- [Recursos](https://github.com/alvarotrigo/fullPage.js#recursos)
- [Quem está usando o fullpage.js](https://github.com/alvarotrigo/fullPage.js#quem-está-usando-o-fullpagejs)
- [Doações](https://github.com/alvarotrigo/fullPage.js#doações)
- [Patrocinadores](https://github.com/alvarotrigo/fullPage.js#patrocinadores)
...
### Uso de extensões
fullpage.js [fornece um conjunto de extensões](http://alvarotrigo.com/fullPage/extensions/) que você pode usar para aprimorar seus recursos padrão. Todos eles estão listados como [opções fullpage.js](https://github.com/alvarotrigo/fullPage.js#options).
...
Então você poderá usá-los e configurá-los conforme explicado em [Opções](https://github.com/alvarotrigo/fullPage.js#options).
...
- `continuousHorizontal`: (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Define se deslizar para a direita no último slide deve deslizar para a direita para o primeiro ou não, e se rolar para a esquerda no primeiro slide deve deslizar para a esquerda para o último ou não. Não compatível com `loopHorizontal`. Requer fullpage.js >= 3.0.1.

- `scrollHorizontally`: (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Define se desliza horizontalmente nos controles deslizantes usando a roda do mouse ou o trackpad. Ele só pode ser usado ao usar: `autoScrolling:true`. Ideal para contar histórias. Requer fullpage.js >= 3.0.1.

- `interlockedSlides`: (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Determina se mover um controle deslizante horizontal forçará o deslizamento dos controles deslizantes em outra seção na mesma direção. Os valores possíveis são `true`, `false` ou uma matriz com as seções interligadas. Por exemplo, `[1,3,5]` começando por 1. Requer fullpage.js >= 3.0.1.

- `dragAndMove`: (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Ativa ou desativa o arrastar e deslizar de seções e slides usando o mouse ou os dedos. Requer fullpage.js >= 3.0.1. Os valores possíveis são:
...
- `offsetSections`: (padrão `false`)[Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Fornece uma maneira de usar seções que não sejam de tela cheia com base na porcentagem. Ideal para mostrar aos visitantes que há mais conteúdo no site, mostrando parte da seção seguinte ou anterior. Requer fullPage.js >= 3.0.1.
...
- `parallax`: (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Define se deve ou não usar os efeitos de fundo de paralaxe em seções/slides. [Leia mais sobre como aplicar a opção de paralaxe](https://github.com/alvarotrigo/fullPage.js/wiki/Extension---Parallax).
...
- `dropEffect` (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Define se deve ou não usar o efeito de soltar nas seções/slides. [Leia mais sobre como aplicar a opção de efeito de soltar](https://github.com/alvarotrigo/fullPage.js/wiki/Extension-Drop-Effect).
...
- `waterEffect` (padrão `false`) [Extensão de fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Define se deve ou não usar o efeito água nas seções/slides. [Leia mais sobre como aplicar a opção de efeito de água](https://github.com/alvarotrigo/fullPage.js/wiki/Extension-Water-Effect).
...
- `cards`: (default `false`) [Extensões do fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Defines whether or not to use the cards effect on sections/slides. [Read more about how to apply the cards option](https://github.com/alvarotrigo/fullPage.js/wiki/Extension-Cards).
...
### getActiveSection()
[Demonstração](https://codepen.io/alvarotrigo/pen/VdpzRN/) Obtém um objeto (tipo [Section](https://github.com/alvarotrigo/fullPage.js#callbacks)) contendo a seção ativa e suas propriedades.
...
### getActiveSlide()
[Demonstração](https://codepen.io/alvarotrigo/pen/VdpzRN/) Obtém um objeto (tipo [Slide](https://github.com/alvarotrigo/fullPage.js#callbacks)) contendo o slide ativo e suas propriedades.
...
Exatamente igual ao [`moveTo`](https://github.com/alvarotrigo/fullPage.js#movetosection-slide) mas neste caso ele realiza o scroll sem animação. Um salto direto para o destino.
```javascript
/*Rolando para a seção com o link âncora `firstSlide` e para o 2º Slide */
...
[Extensões do fullpage.js](http://alvarotrigo.com/fullPage/extensions/). Requer fullpage.js >= 3.0.1.
...
Você pode cancelar um movimento retornando `false` no retorno de chamada `onSlideLeave`. [O mesmo que cancelar um movimento com `onLeave`](https://github.com/alvarotrigo/fullPage.js#cancelling-the-scroll-before-it-takes-place).
