...
c+'"]').addClass("active"):a("#fp-nav").find("li").eq(d).find("a").addClass("active"))}function H(c){b.menu&&(a(b.menu).find(".active").removeClass("active"),a(b.menu).find('[data-menuanchor="'+c+'"]').addClass("active"))}function C(c,a){if("top"===c)return!a.scrollTop();if("bottom"===c)return a.scrollTop()+1+a.innerHeight()>=a[0].scrollHeight}function G(c){var b=a(".fp-section.active").index(".fp-section");c=c.index(".fp-section");return b>c?"up":"down"}function z(c){c.css("overflow","hidden");var a=
c.closest(".fp-section"),e=c.find(".fp-scrollable");if(e.length)var f=e.get(0).scrollHeight;else f=c.get(0).scrollHeight,b.verticalCentered&&(f=c.find(".fp-tableCell").get(0).scrollHeight);a=l-parseInt(a.css("padding-bottom"))-parseInt(a.css("padding-top"));f>a?e.length?e.css("height",a+"px").parent().css("height",a+"px"):(b.verticalCentered?c.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />'):c.wrapInner('<div class="fp-scrollable" />'),c.find(".fp-scrollable").slimScroll({allowPageScroll:!0,
height:a+"px",size:"10px",alwaysVisible:!0})):Y(c);c.css("overflow","")}function Y(a){a.find(".fp-scrollable").children().first().unwrap().unwrap();a.find(".slimScrollBar").remove();a.find(".slimScrollRail").remove()}function Z(a){a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:'+$(a)+'px;" />')}function $(a){var d=l;if(b.paddingTop||b.paddingBottom)d=a,d.hasClass("fp-section")||(d=a.closest(".fp-section")),a=parseInt(d.css("padding-top"))+parseInt(d.css("padding-bottom")),
