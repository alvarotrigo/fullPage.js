...
b.length?b.each(function(){w(a(this))}):w(a(this))});a.isFunction(c.afterRender)&&c.afterRender.call(this)}function J(){if(!c.autoScrolling||c.scrollBar){var b=a(window).scrollTop(),d=0,e=Math.abs(b-a(".fp-section").first().offset().top);a(".fp-section").each(function(c){var f=Math.abs(b-a(this).offset().top);f<e&&(d=c,e=f)});var f=a(".fp-section").eq(d)}if(!c.autoScrolling&&!f.hasClass("active")){A=!0;var g=a(".fp-section.active").index(".fp-section")+1,ha=B(f),h=f.data("anchor");f.addClass("active").siblings().removeClass("active");
l||(a.isFunction(c.onLeave)&&c.onLeave.call(this,g,f.index(".fp-section")+1,ha),a.isFunction(c.afterLoad)&&c.afterLoad.call(this,h,f.index(".fp-section")+1));C(h,0);c.anchors.length&&!l&&(q=h,location.hash=h);clearTimeout(K);K=setTimeout(function(){A=!1},100)}c.scrollBar&&(clearTimeout(L),L=setTimeout(function(){l||m(f)},1E3))}function M(b){return scrollable=b.find(".fp-slides").length?b.find(".fp-slide.active").find(".fp-scrollable"):b.find(".fp-scrollable")}function x(b,d){if("down"==b)var c="bottom",
...
a.fn.fullpage.moveSlideLeft()):c.autoScrolling&&Math.abs(s-r)>a(window).height()/100*c.touchSensitivity&&(s>r?x("down",e):r>s&&x("up",e)))}}function N(b,d){d=d||0;var e=a(b).parent();return d<c.normalScrollElementTouchThreshold&&e.is(c.normalScrollElements)?!0:d==c.normalScrollElementTouchThreshold?!1:N(e,++d)}function ja(b){b=O(b.originalEvent);s=b.y;z=b.x}function n(b){if(c.autoScrolling){b=window.event||b;var d=Math.max(-1,Math.min(1,b.wheelDelta||-b.deltaY||-b.detail));c.scrollBar&&(b.preventDefault?
b.preventDefault():b.returnValue=!1);b=a(".fp-section.active");b=M(b);l||(0>d?x("down",b):x("up",b));return!1}}function P(b){var d=a(".fp-section.active").find(".fp-slides");if(d.length&&!t){var e=d.find(".fp-slide.active"),f=null,f="prev"===b?e.prev(".fp-slide"):e.next(".fp-slide");if(!f.length){if(!c.loopHorizontal)return;f="prev"===b?e.siblings(":last"):e.siblings(":first")}t=!0;u(d,f)}}function Q(){a(".fp-slide.active").each(function(){D(a(this))})}function m(b,d,e){var f=b.position();if("undefined"!==
typeof f&&(d={element:b,callback:d,isMovementUp:e,dest:f,dtop:f.top,yMovement:B(b),anchorLink:b.data("anchor"),sectionIndex:b.index(".fp-section"),activeSlide:b.find(".fp-slide.active"),activeSection:a(".fp-section.active"),leavingSection:a(".fp-section.active").index(".fp-section")+1,localIsResizing:v},!(d.activeSection.is(b)&&!v||c.scrollBar&&a(window).scrollTop()===d.dtop))){if(d.activeSlide.length)var g=d.activeSlide.data("anchor"),h=d.activeSlide.index();c.autoScrolling&&c.continuousVertical&&
"undefined"!==typeof d.isMovementUp&&(!d.isMovementUp&&"up"==d.yMovement||d.isMovementUp&&"down"==d.yMovement)&&(d.isMovementUp?a(".fp-section.active").before(d.activeSection.nextAll(".fp-section")):a(".fp-section.active").after(d.activeSection.prevAll(".fp-section").get().reverse()),p(a(".fp-section.active").position().top),Q(),d.wrapAroundElements=d.activeSection,d.dest=d.element.position(),d.dtop=d.dest.top,d.yMovement=B(d.element));b.addClass("active").siblings().removeClass("active");l=!0;"undefined"!==
typeof d.anchorLink&&R(h,g,d.anchorLink);a.isFunction(c.onLeave)&&!d.localIsResizing&&c.onLeave.call(this,d.leavingSection,d.sectionIndex+1,d.yMovement);ka(d);q=d.anchorLink;c.autoScrolling&&C(d.anchorLink,d.sectionIndex)}}function ka(b){if(c.css3&&c.autoScrolling)S("translate3d(0px, -"+b.dtop+"px, 0px)",!0),setTimeout(function(){T(b)},c.scrollingSpeed);else{var d=la(b);a(d.element).animate(d.options,c.scrollingSpeed,c.easing).promise().done(function(){T(b)})}}function la(b){var a={};c.autoScrolling&&
!c.scrollBar?(a.options={top:-b.dtop},a.element="."+U):(a.options={scrollTop:b.dtop},a.element="html, body");return a}function ma(b){b.wrapAroundElements&&b.wrapAroundElements.length&&(b.isMovementUp?a(".fp-section:first").before(b.wrapAroundElements):a(".fp-section:last").after(b.wrapAroundElements),p(a(".fp-section.active").position().top),Q())}function T(b){ma(b);a.isFunction(c.afterLoad)&&!b.localIsResizing&&c.afterLoad.call(this,b.anchorLink,b.sectionIndex+1);setTimeout(function(){l=!1;a.isFunction(b.callback)&&
b.callback.call(this)},600)}function V(){if(!A){var b=window.location.hash.replace("#","").split("/"),a=b[0],b=b[1];if(a.length){var c="undefined"===typeof q,f="undefined"===typeof q&&"undefined"===typeof b&&!t;(a&&a!==q&&!c||f||!t&&E!=b)&&F(a,b)}}}function u(b,d){var e=d.position(),f=b.find(".fp-slidesContainer").parent(),g=d.index(),h=b.closest(".fp-section"),l=h.index(".fp-section"),m=h.data("anchor"),p=h.find(".fp-slidesNav"),k=d.data("anchor"),q=v;if(c.onSlideLeave){var n=h.find(".fp-slide.active").index(),
r;r=n==g?"none":n>g?"left":"right";q||"none"===r||a.isFunction(c.onSlideLeave)&&c.onSlideLeave.call(this,m,l+1,n,r)}d.addClass("active").siblings().removeClass("active");"undefined"===typeof k&&(k=g);c.loopHorizontal||(h.find(".fp-controlArrow.fp-prev").toggle(0!=g),h.find(".fp-controlArrow.fp-next").toggle(!d.is(":last-child")));h.hasClass("active")&&R(g,k,m);var s=function(){q||a.isFunction(c.afterSlideLoad)&&c.afterSlideLoad.call(this,m,l+1,k,g);t=!1};c.css3?(e="translate3d(-"+e.left+"px, 0px, 0px)",
W(b.find(".fp-slidesContainer"),0<c.scrollingSpeed).css(X(e)),setTimeout(function(){s()},c.scrollingSpeed,c.easing)):f.animate({scrollLeft:e.left},c.scrollingSpeed,c.easing,function(){s()});p.find(".active").removeClass("active");p.find("li").eq(g).find("a").addClass("active")}function Y(){Z();G?"text"!==a(document.activeElement).attr("type")&&a.fn.fullpage.reBuild(!0):(clearTimeout($),$=setTimeout(function(){a.fn.fullpage.reBuild(!0)},500))}function Z(){if(c.responsive){var b=g.hasClass("fp-responsive");
a(window).width()<c.responsive?b||(a.fn.fullpage.setAutoScrolling(!1),a("#fp-nav").hide(),g.addClass("fp-responsive")):b&&(a.fn.fullpage.setAutoScrolling(!0),a("#fp-nav").show(),g.removeClass("fp-responsive"))}}function W(b,a){var e="all "+c.scrollingSpeed+"ms "+c.easingcss3;return a?(b.removeClass("fp-notransition"),b.css({"-webkit-transition":e,transition:e})):H(b)}function H(b){return b.addClass("fp-notransition")}function na(b,c){if(825>b||900>c){var e=Math.min(100*b/825,100*c/900).toFixed(2);
a("body").css("font-size",e+"%")}else a("body").css("font-size","100%")}function C(b,d){c.menu&&(a(c.menu).find(".active").removeClass("active"),a(c.menu).find('[data-menuanchor="'+b+'"]').addClass("active"));c.navigation&&(a("#fp-nav").find(".active").removeClass("active"),b?a("#fp-nav").find('a[href="#'+b+'"]').addClass("active"):a("#fp-nav").find("li").eq(d).find("a").addClass("active"))}function B(b){var c=a(".fp-section.active").index(".fp-section");b=b.index(".fp-section");return c==b?"none":
c>b?"up":"down"}function w(b){b.css("overflow","hidden");var a=b.closest(".fp-section"),e=b.find(".fp-scrollable");if(e.length)var f=e.get(0).scrollHeight;else f=b.get(0).scrollHeight,c.verticalCentered&&(f=b.find(".fp-tableCell").get(0).scrollHeight);a=k-parseInt(a.css("padding-bottom"))-parseInt(a.css("padding-top"));f>a?e.length?e.css("height",a+"px").parent().css("height",a+"px"):(c.verticalCentered?b.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />'):b.wrapInner('<div class="fp-scrollable" />'),
