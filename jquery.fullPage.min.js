...
c.length?c.each(function(){y(a(this))}):y(a(this))});a.isFunction(b.afterRender)&&b.afterRender.call(this)}function N(){if(!b.autoScrolling){var c=a(window).scrollTop(),d=0,e=Math.abs(c-a(".fp-section").first().offset().top);a(".fp-section").each(function(b){var f=Math.abs(c-a(this).offset().top);f<e&&(d=b,e=f)});var f=a(".fp-section").eq(d);if(!f.hasClass("active")&&!r){E=!0;var g=a(".fp-section.active").index(".fp-section")+1,n=F(f),k=f.data("anchor");f.addClass("active").siblings().removeClass("active");
a.isFunction(b.onLeave)&&b.onLeave.call(this,g,f.index(".fp-section")+1,n);a.isFunction(b.afterLoad)&&b.afterLoad.call(this,k,f.index(".fp-section")+1);G(k);H(k,0);b.anchors.length&&!r&&(w=k,location.hash=k);clearTimeout(O);O=setTimeout(function(){E=!1},100)}b.fitSection&&(clearTimeout(P),P=setTimeout(function(){r||p(f)},1E3))}}function Q(c){return scrollable=c.find(".fp-slides").length?c.find(".fp-slide.active").find(".fp-scrollable"):c.find(".fp-scrollable")}function z(c,b){if("down"==c)var e="bottom",
f=a.fn.fullpage.moveSectionDown;else e="top",f=a.fn.fullpage.moveSectionUp;if(0<b.length)if(e="top"===e?!b.scrollTop():"bottom"===e?b.scrollTop()+1+b.innerHeight()>=b[0].scrollHeight:void 0,e)f();else return!0;else f()}function ia(c){var d=c.originalEvent;if(!R(c.target)){b.autoScrolling&&c.preventDefault();c=a(".fp-section.active");var e=Q(c);r||t||(d=S(d),l=d.y,A=d.x,c.find(".fp-slides").length&&Math.abs(B-A)>Math.abs(s-l)?Math.abs(B-A)>a(window).width()/100*b.touchSensitivity&&(B>A?a.fn.fullpage.moveSlideRight():
...
d=Q(d);r||(0>c?z("down",d):z("up",d));return!1}}function T(c){var d=a(".fp-section.active").find(".fp-slides");if(d.length&&!t){var e=d.find(".fp-slide.active"),f=null,f="prev"===c?e.prev(".fp-slide"):e.next(".fp-slide");if(!f.length){if(!b.loopHorizontal)return;f="prev"===c?e.siblings(":last"):e.siblings(":first")}t=!0;x(d,f)}}function U(){a(".fp-slide.active").each(function(){I(a(this))})}function p(c,d,e){var f={},g=c.position();if("undefined"!==typeof g){var g=g.top,n=F(c),k=c.data("anchor"),
h=c.index(".fp-section"),m=c.find(".fp-slide.active"),C=a(".fp-section.active"),p=C.index(".fp-section")+1,q=D;if(m.length)var t=m.data("anchor"),u=m.index();if(b.autoScrolling&&b.continuousVertical&&"undefined"!==typeof e&&(!e&&"up"==n||e&&"down"==n)){e?a(".fp-section.active").before(C.nextAll(".fp-section")):a(".fp-section.active").after(C.prevAll(".fp-section").get().reverse());v(a(".fp-section.active").position().top);U();var l=C,g=c.position(),g=g.top,n=F(c)}c.addClass("active").siblings().removeClass("active");
r=!0;"undefined"!==typeof k&&V(u,t,k);b.autoScrolling?(f.top=-g,c="."+W):(f.scrollTop=g,c="html, body");var s=function(){l&&l.length&&(e?a(".fp-section:first").before(l):a(".fp-section:last").after(l),v(a(".fp-section.active").position().top),U());a.isFunction(b.afterLoad)&&!q&&b.afterLoad.call(this,k,h+1);setTimeout(function(){r=!1;a.isFunction(d)&&d.call(this)},600)};a.isFunction(b.onLeave)&&!q&&b.onLeave.call(this,p,h+1,n);b.css3&&b.autoScrolling?(X("translate3d(0px, -"+g+"px, 0px)",!0),setTimeout(function(){s()},
...
m=n.find(".fp-slidesNav"),l=d.data("anchor"),q=D;if(b.onSlideLeave){var p=n.find(".fp-slide.active").index(),r;r=p==g?"none":p>g?"left":"right";q||"none"===r||a.isFunction(b.onSlideLeave)&&b.onSlideLeave.call(this,h,k+1,p,r)}d.addClass("active").siblings().removeClass("active");"undefined"===typeof l&&(l=g);b.loopHorizontal||(n.find(".fp-controlArrow.fp-prev").toggle(0!=g),n.find(".fp-controlArrow.fp-next").toggle(!d.is(":last-child")));n.hasClass("active")&&V(g,l,h);var s=function(){q||a.isFunction(b.afterSlideLoad)&&
...
da(a)+'px;" />')}function da(a){var d=q;if(b.paddingTop||b.paddingBottom)d=a,d.hasClass("fp-section")||(d=a.closest(".fp-section")),a=parseInt(d.css("padding-top"))+parseInt(d.css("padding-bottom")),d=q-a;return d}function X(a,b){h.toggleClass("fp-easing",b);h.css(Z(a))}function K(c,b){"undefined"===typeof b&&(b=0);var e=isNaN(c)?a('[data-anchor="'+c+'"]'):a(".fp-section").eq(c-1);c===w||e.hasClass("active")?ea(e,b):p(e,function(){ea(e,b)})}function ea(a,b){if("undefined"!=typeof b){var e=a.find(".fp-slides"),
...
MSPointer.move,ia)}else if(a.fn.fullpage.setMouseWheelScrolling(!1),L||ga)MSPointer=fa(),a(document).off("touchstart "+MSPointer.down),a(document).off("touchmove "+MSPointer.move)};a.fn.fullpage.setKeyboardScrolling=function(a){b.keyboardScrolling=a};a.fn.fullpage.moveSectionUp=function(){var c=a(".fp-section.active").prev(".fp-section");c.length||!b.loopTop&&!b.continuousVertical||(c=a(".fp-section").last());c.length&&p(c,null,!0)};a.fn.fullpage.moveSectionDown=function(){var c=a(".fp-section.active").next(".fp-section");
c.length||!b.loopBottom&&!b.continuousVertical||(c=a(".fp-section").first());c.length&&p(c,null,!1)};a.fn.fullpage.moveTo=function(b,d){var e="",e=isNaN(b)?a('[data-anchor="'+b+'"]'):a(".fp-section").eq(b-1);"undefined"!==typeof d?K(b,d):0<e.length&&p(e)};a.fn.fullpage.moveSlideRight=function(){T("next")};a.fn.fullpage.moveSlideLeft=function(){T("prev")};a.fn.fullpage.reBuild=function(c){D=!0;var d=a(window).width();q=a(window).height();b.resize&&ka(q,d);a(".fp-section").each(function(){parseInt(a(this).css("padding-bottom"));
parseInt(a(this).css("padding-top"));b.verticalCentered&&a(this).find(".fp-tableCell").css("height",da(a(this))+"px");a(this).css("height",q+"px");if(b.scrollOverflow){var c=a(this).find(".fp-slide");c.length?c.each(function(){y(a(this))}):y(a(this))}c=a(this).find(".fp-slides");c.length&&x(c,c.find(".fp-slide.active"))});a(".fp-section.active").position();d=a(".fp-section.active");d.index(".fp-section")&&p(d);D=!1;a.isFunction(b.afterResize)&&c&&b.afterResize.call(this);a.isFunction(b.afterReBuild)&&
!c&&b.afterReBuild.call(this)};var t=!1,L=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),ga="ontouchstart"in window||0<navigator.msMaxTouchPoints,h=a(this),q=a(window).height(),r=!1,D=!1,w,J,m,W="fullpage-wrapper";a.fn.fullpage.setAllowScrolling(!0);b.css3&&(b.css3=ma());a(this).length?(h.css({height:"100%",position:"relative"}),h.addClass(W)):console.error("Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
a(b.sectionSelector).each(function(){a(this).addClass("fp-section")});a(b.slideSelector).each(function(){a(this).addClass("fp-slide")});b.navigation&&ha();a(".fp-section").each(function(c){var d=a(this),e=a(this).find(".fp-slide"),f=e.length;c||0!==a(".fp-section.active").length||a(this).addClass("active");a(this).css("height",q+"px");(b.paddingTop||b.paddingBottom)&&a(this).css("padding",b.paddingTop+" 0 "+b.paddingBottom+" 0");"undefined"!==typeof b.sectionsColor[c]&&a(this).css("background-color",
...
window.location.hash.replace("#","").split("/"),b=a[0],a=a[1];b&&K(b,a)})});a("html, body").bind("scroll mousedown DOMMouseScroll mousewheel keyup",function(){!b.autoScrolling&&b.fitSection&&a("html, body").stop()});var O,P,E=!1;a(window).on("scroll",N);var s=0,B=0,l=0,A=0;a(window).on("hashchange",Y);a(document).keydown(function(c){if(b.keyboardScrolling&&!r)switch(c.which){case 38:case 33:a.fn.fullpage.moveSectionUp();break;case 40:case 34:a.fn.fullpage.moveSectionDown();break;case 36:a.fn.fullpage.moveTo(1);
break;case 35:a.fn.fullpage.moveTo(a(".fp-section").length);break;case 37:a.fn.fullpage.moveSlideLeft();break;case 39:a.fn.fullpage.moveSlideRight()}});a(document).on("click touchstart","#fp-nav a",function(b){b.preventDefault();b=a(this).parent().index();p(a(".fp-section").eq(b))});a(document).on("click touchstart",".fp-slidesNav a",function(b){b.preventDefault();b=a(this).closest(".fp-section").find(".fp-slides");var d=b.find(".fp-slide").eq(a(this).closest("li").index());x(b,d)});a(document).on({mouseenter:function(){var c=
