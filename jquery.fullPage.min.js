...
a;break;case "all":e.setAllowScrolling(a)}})):a?(e.setMouseWheelScrolling(!0),Ka()):(e.setMouseWheelScrolling(!1),La())};e.setKeyboardScrolling=function(a){d.keyboardScrolling=a};e.moveSectionUp=function(){var a=c(".fp-section.active").prev(".fp-section:visible");a.length||!d.loopTop&&!d.continuousVertical||(a=c(".fp-section:visible").last());a.length&&q(a,null,!0)};e.moveSectionDown=function(){var a=c(".fp-section.active").next(".fp-section:visible");a.length||!d.loopBottom&&!d.continuousVertical||(a=c(".fp-section:visible").first());
