...
x("up",e)))}}function P(b,d){d=d||0;var e=a(b).parent();return d<c.normalScrollElementTouchThreshold&&e.is(c.normalScrollElements)?!0:d==c.normalScrollElementTouchThreshold?!1:P(e,++d)}function ha(b){b=Q(b.originalEvent);q=b.y;z=b.x}function m(b){if(c.autoScrolling){b=window.event||b;b=Math.max(-1,Math.min(1,b.wheelDelta||-b.deltaY||-b.detail));var d=a(".fp-section.active"),d=O(d);u||(0>b?x("down",d):x("up",d));return!1}}function R(b){var d=a(".fp-section.active").find(".fp-slides");if(d.length&&
...
ba(a(this))+"px");a(this).css("height",k+"px");if(c.scrollOverflow){var b=a(this).find(".fp-slide");b.length?b.each(function(){w(a(this))}):w(a(this))}b=a(this).find(".fp-slides");b.length&&p(b,b.find(".fp-slide.active"))});a(".fp-section.active").position();d=a(".fp-section.active");d.index(".fp-section")&&r(d);C=!1;a.isFunction(c.afterResize)&&b&&c.afterResize.call(this);a.isFunction(c.afterReBuild)&&!b&&c.afterReBuild.call(this)};var t=!1,K=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
