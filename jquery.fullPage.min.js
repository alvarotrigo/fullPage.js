...
c.scrollingSpeed,c.easing)):e.animate({scrollLeft:d.left},c.scrollingSpeed,c.easing,function(){m||b.isFunction(c.afterSlideLoad)&&c.afterSlideLoad.call(this,h,p+1,l,g);r=!1});n.find(".active").removeClass("active");n.find("li").eq(g).find("a").addClass("active")}function R(){F=!0;var a=b(window).width();h=b(window).height();c.resize&&Z(h,a);b(".section").each(function(){parseInt(b(this).css("padding-bottom"));parseInt(b(this).css("padding-top"));c.verticalCentered&&b(this).find(".tableCell").css("height",
S(b(this))+"px");b(this).css("height",h+"px");if(c.scrollOverflow){var a=b(this).find(".slide");a.length?a.each(function(){C(b(this))}):C(b(this))}a=b(this).find(".slides");a.length&&u(a,a.find(".slide.active"))});b(".section.active").position();a=b(".section.active");a.index(".section")&&n(a);F=!1}function Z(a,c){var d=825,e=a;825>a||900>c?(900>c&&(e=c,d=900),d=(100*e/d).toFixed(2),b("body").css("font-size",d+"%")):b("body").css("font-size","100%")}function P(a,f){c.navigation&&(b("#fullPage-nav").find(".active").removeClass("active"),
...
m,!1),document.removeEventListener("wheel",m,!1)):document.detachEvent("onmousewheel",m)};b.fn.fullpage.setAllowScrolling=function(a){a?(b.fn.fullpage.setMouseWheelScrolling(!0),I&&(b(document).off("touchstart MSPointerDown").on("touchstart MSPointerDown",Y),b(document).off("touchmove MSPointerMove").on("touchmove MSPointerMove",X))):(b.fn.fullpage.setMouseWheelScrolling(!1),I&&(b(document).off("touchstart MSPointerDown"),b(document).off("touchmove MSPointerMove")))};b.fn.fullpage.setKeyboardScrolling=
function(a){c.keyboardScrolling=a};var r=!1,I=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone)/),h=b(window).height(),q=!1,F=!1,t,H;b.fn.fullpage.setAllowScrolling(!0);c.css3&&(c.css3=aa());b("body").wrapInner('<div id="superContainer" />');if(c.navigation){b("body").append('<div id="fullPage-nav"><ul></ul></div>');var v=b("#fullPage-nav");v.css("color",c.navigationColor);v.addClass(c.navigationPosition)}b(".section").each(function(a){var f=b(this),d=b(this).find(".slide"),
...
G(b,a)})});var V,J=!1;b(window).scroll(function(a){if(!c.autoScrolling){var f=b(window).scrollTop();a=b(".section").map(function(){if(b(this).offset().top<f+100)return b(this)});a=a[a.length-1];if(!a.hasClass("active")){J=!0;var d=D(a);b(".section.active").removeClass("active");a.addClass("active");var e=a.data("anchor");b.isFunction(c.onLeave)&&c.onLeave.call(this,a.index(".section"),d);b.isFunction(c.afterLoad)&&c.afterLoad.call(this,e,a.index(".section")+1);O(e);P(e,0);c.anchors.length&&!q&&(t=
...
c.prev(".slide"):c.next(".slide");d.length||(d=b(this).hasClass("prev")?c.siblings(":last"):c.siblings(":first"));u(a,d)}});b(".section").on("click",".toSlide",function(a){a.preventDefault();a=b(this).closest(".section").find(".slides");a.find(".slide.active");var c=null,c=a.find(".slide").eq(b(this).data("index")-1);0<c.length&&u(a,c)});if(!I){var W;b(window).resize(function(){clearTimeout(W);W=setTimeout(R,500)})}b(window).bind("orientationchange",function(){R()});b(document).on("click",".fullPage-slidesNav a",
function(a){a.preventDefault();a=b(this).closest(".section").find(".slides");var c=a.find(".slide").eq(b(this).closest("li").index());u(a,c)})}})(jQuery);