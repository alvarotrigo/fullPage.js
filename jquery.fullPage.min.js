...
!1,G=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),u=a(this),k=a(window).height(),t=!1,D=!1,v,J;a.fn.fullpage.setAllowScrolling(!0);c.css3&&(c.css3=da());a(this).length?u.css({height:"100%",position:"relative","-ms-touch-action":"none"}):(a("body").wrapInner('<div id="superContainer" />'),u=a("#superContainer"));if(c.navigation){a("body").append('<div id="fullPage-nav"><ul></ul></div>');var m=a("#fullPage-nav");m.css("color",c.navigationColor);m.addClass(c.navigationPosition)}a(".section").each(function(b){var e=
